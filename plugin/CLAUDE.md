...
For logo assets at runtime, prefer the canonical CDN paths documented in `skills/applying-design-system/SKILL.md` (`http://assets.acceleratedata.ai/logo/`) over any local copies.
