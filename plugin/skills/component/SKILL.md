...
x-adapter-version: 2026-04-25.1
name: component
description: |
...
- **Adapt to project**: Read repo agent guidance and codebase: use AGENTS.md for Codex, CLAUDE.md for Claude, and read both when both exist. Match the project's naming, not the skill's.
